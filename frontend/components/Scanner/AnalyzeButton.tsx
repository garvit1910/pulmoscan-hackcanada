...
export default function AnalyzeButton({ onClick, isAnalyzing, disabled }: AnalyzeButtonProps) {
  return (
    <motion.button
      ...
      whileTap={{ x: 2, y: 2 }}
      className="relative w-full py-4 bg-[#E8506A] text-[#120D0B] font-pixel text-sm rounded-none border-4 border-[#E8506A] shadow-pixel overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 hover:shadow-[0_0_20px_rgba(232,80,106,0.6)] transition-shadow active:translate-x-[2px] active:translate-y-[2px] active:shadow-pixel-sm"
    >
